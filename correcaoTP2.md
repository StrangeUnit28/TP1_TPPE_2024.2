...
Observações: 
- Refatoração "Substituir método por objeto-metodo" não criou referencia para o objeto de origem. 
- Refatoração "Extrair Classe" não criou nova classe à partir da movimentacao de atributos e métodos que estão sempre juntos. 
- 
- 
